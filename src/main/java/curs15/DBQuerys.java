...
//query ul trebuie sa fie cat mai precis, sa cauti cat mai clar ceva, pentru a nu avea un rezultat generic prea stufos
...
public class DBQuerys {
	...
	public static void dbUpdateQuery(Connection conn, String query) {
		...
		try {
			...
			Statement statement = conn.createStatement();
			statement.executeUpdate(query); //la fel se face pt delete sau insert, tot cu update
